...
function useIsPresent() {
  return isPresent((0, import_react25.useContext)(PresenceContext));
}
...
var LayoutGroup = function(_a) {
  ...
  if (inheritId !== void 0)
    inherit = inheritId;
  var layoutGroupContext = (0, import_react35.useContext)(LayoutGroupContext);
  var deprecatedLayoutGroupContext = (0, import_react35.useContext)(DeprecatedLayoutGroupContext);
  var _e = __read(useForceUpdate(), 2), forceRender = _e[0], key = _e[1];
  var context = (0, import_react35.useRef)(null);
  ...
  var memoizedContext = (0, import_react35.useMemo)(function() {
...
var AnimateSharedLayout = function(_a) {
  ...
  return React6.createElement(LayoutGroup, { id: useConstant(function() {
...
function MotionConfig(_a) {
  ...
  config = __assign(__assign({}, (0, import_react36.useContext)(MotionConfigContext)), config);
...
function LazyMotion(_a) {
  ...
  var _c = __read((0, import_react37.useState)(!isLazyBundle(features)), 2), setIsLoaded = _c[1];
  var loadedRenderer = (0, import_react37.useRef)(void 0);
...
function useSpring(source, config) {
  ...
  var activeSpringAnimation = (0, import_react42.useRef)(null);
...
function updateAxisInfo(element, axisName, info, time2) {
  ...
  axis.velocity = elapsed > maxElapsed3 ? 0 : velocityPerSecond2(axis.current - prev, elapsed);
}
...
function useAnimationFrame(callback) {
  var initialTimestamp = useConstant(getCurrentTime3);
  var isStatic = (0, import_react44.useContext)(MotionConfigContext).isStatic;
  (0, import_react44.useEffect)(function() {
    ...
    es_default2.update(provideTimeSinceStart, true);
    return function() {
      return cancelSync2.update(provideTimeSinceStart);
    };
  }, [callback]);
}
...
function useCycle() {
  ...
  var index2 = (0, import_react46.useRef)(0);
  var _a = __read((0, import_react46.useState)(items[index2.current]), 2), item = _a[0], setItem = _a[1];
  var runCycle = (0, import_react46.useCallback)(function(next) {
...
function useInView(ref, _a) {
  ...
  var _d = __read((0, import_react47.useState)(false), 2), isInView = _d[0], setInView = _d[1];
...
function useInstantTransition() {
  ...
  (0, import_react48.useEffect)(function() {
    es_default2.postRender(function() {
      return es_default2.postRender(function() {
...
function useAnimatedState(initialState) {
  var _a = __read((0, import_react49.useState)(initialState), 2), animationState = _a[0], setAnimationState = _a[1];
...
//# sourceMappingURL=chunk-LH4LMOZ6.js.map
